$(document).ready(function() {
    let attributeValues = window.attributeValues || [];

    // Điền tên thuộc tính
    $('#attributeName').val(window.productAttribute.name);

    

    // Phần còn lại của mã hiện có để thêm/chỉnh sửa/xóa giá trị thuộc tính
